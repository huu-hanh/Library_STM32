...
void I2C1_GPIOInits(void){
	...
	I2CPins.GPIO_PinConfig.GPIO_PinCNF = GPIO_CNF_OUT_AF_OD;
	I2CPins.GPIO_PinConfig.GPIO_PinMode = GPIO_MODE_OUT_MAX_SPEED_10MHZ;
...
int main(void){
	...
	I2C_LCD_print_string(&LCD, "DM 2 thang lon");
	while(1){
